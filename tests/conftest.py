...
def device(request, hid):
    ...
    base_args = [
        speculos_executable, "./plcultima-testnet-bin/app.elf",
        "-l", "PLC Ultima:./plcultima-bin/app.elf",
        "--sdk", "2.0",
        "--display", "headless",
        "--seed", "tackle kit shed defense able original when van delay vanish odor hello fire vault jazz receive visit dream menu judge vacant cheap ten fringe"
    ]
